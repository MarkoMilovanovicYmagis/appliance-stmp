package com.ymagis.emulator.appliancestmp.snmp;

import com.ymagis.emulator.appliancestmp.agent.Mib2System;
import com.ymagis.emulator.appliancestmp.agent.MibEntry;
import com.ymagis.emulator.appliancestmp.agent.OidComparator;
import com.ymagis.emulator.appliancestmp.asn.*;
import com.ymagis.emulator.appliancestmp.asn.ber.BerTlv;
import com.ymagis.emulator.appliancestmp.snmp.exception.SnmpSystemException;
import com.ymagis.emulator.appliancestmp.types.*;
...
public class SnmpAgent implements Runnable {
    ...
    public SnmpAgent(int listeningPort, String readOnlyComunity, String readWriteComunity, Mib2System mib2System, String[] handledOidPrefixes) {
    ...
    private void addSystemMibEntries() {
        ...
        if (mib2System != null) {
            MibEntry entry = new MibEntry("1.3.6.1.2.1.1.1.0", mib2System, "sysDescr", AsnOctetString.class);
            systemMibEntryMap.put(entry.getOidDigits(), entry);
            entry = new MibEntry("1.3.6.1.2.1.1.2.0", mib2System, "sysObjectId", AsnOID.class);
            systemMibEntryMap.put(entry.getOidDigits(), entry);
            entry = new MibEntry("1.3.6.1.2.1.1.3.0", mib2System, "sysUpTime", SmiTimeTicks.class);
            systemMibEntryMap.put(entry.getOidDigits(), entry);
            entry = new MibEntry("1.3.6.1.2.1.1.4.0", mib2System, "sysContact", AsnOctetString.class);
            systemMibEntryMap.put(entry.getOidDigits(), entry);
            entry = new MibEntry("1.3.6.1.2.1.1.5.0", mib2System, "sysName", AsnOctetString.class);
            systemMibEntryMap.put(entry.getOidDigits(), entry);
            entry = new MibEntry("1.3.6.1.2.1.1.6.0", mib2System, "sysLocation", AsnOctetString.class);
            systemMibEntryMap.put(entry.getOidDigits(), entry);
            entry = new MibEntry("1.3.6.1.2.1.1.7.0", mib2System, "sysServices", AsnInteger.class);
            systemMibEntryMap.put(entry.getOidDigits(), entry);
        }
        if (mibEntries == null)
